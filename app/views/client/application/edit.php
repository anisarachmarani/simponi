                            ...
                            <div class="page-title-box d-sm-flex align-items-center
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="<?php echo site_url('client/Application') ?>">Applikasi</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-6">
                                            <div class="mt-4 mt-lg-0">
                                                <form action="<?php echo site_url("index.php/client/Application/update") ?>" method="POST">

                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="<?php echo base_url(); ?>client/Billing" class="btn btn-primary waves-effect waves-light">Selengkapnya</a>
                                    </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <a href="<?php echo base_url(); ?>client/Bank" class="btn btn-primary waves-effect waves-light w-50 mt-3">Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                        <!-- end col -->
                        ...
                        <div class="col-12 col-md-6">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <a href="<?php echo base_url(); ?>client/Department" class="btn btn-primary waves-effect waves-light w-50 mt-3">Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                        <!-- end col -->

                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a
                                                href="<?php echo site_url('client') ?>">Dashboard</a></li>
                                        <li class="breadcrumb-item"><a
                                                href="<?php echo site_url('client/Department') ?>">Departemen</a>
                                        </li>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row justify-content-between align-items-center">
                                        <h4 class="card-title col-6">Tambah Departemen</h4>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12 px-0 px-md-5">
                                            <div class="mt-0">
                                                <form
                                                    action="<?php echo site_url("index.php/client/Department/store") ?>"
                                                    method="POST">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                        ...
                                                        <div class="col-4">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="code_ga"
                                                                    name="code_ga" value="090" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-4">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="code_echelon_1" name="code_echelon_1" value="03"
                                                                    required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row justify-content-start">
                                                        <div class="col-sm-9">
                                                            <div>
                                                                ...
                                                                <a href="<?php echo site_url("index.php/client/Department") ?>"

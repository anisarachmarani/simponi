                                ...
                                <div class="card-header">
                                    <div class="row justify-content-between align-items-center">
                                        ...
                                        <div class="col-6 text-end">
                                            <a href="<?php echo site_url("index.php/client/User/create") ?>" class="btn btn-primary">Tambah <span class="d-none d-md-inline">User</span></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            <?php foreach ($user as $key => $item) : ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-wrap">
                                                        <a href="<?php echo site_url('client/User/edit/'.$item->id) ?>" class="btn btn-info">Ubah</a>
                                                        <a href="<?php echo site_url('client/User/delete/'.$item->id) ?>" class="btn btn-danger">Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>

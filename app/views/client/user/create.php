                            ...
                            <div class="page-title-box d-sm-flex align-items-center
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="<?php echo site_url('client/User') ?>">User</a></li>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row justify-content-between align-items-center">
                                        <h4 class="card-title col-6">Tambah User</h4>
                                    </div>
                                </div>
                                <div class="card-body">

                                    <form action="<?php echo site_url("index.php/client/User/store") ?>" method="POST">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-lg-6">
                                                <div class="mt-4 mt-lg-0">
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select class="form-control" data-trigger name="application_id" id="application_id" required>
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select class="form-control" data-trigger name="role" id="role" required>
                                                                <?php foreach ($roles as $value) : ?>
                                                                    <option <?php echo ($value->id == "RL03") ? 'selected' : '' ?> value="<?= $value->id; ?>"><?= $value->name; ?></option>
                                                                <?php endforeach ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select class="form-control" data-trigger name="status" id="status" required>
                                                                <option value="US01" selected>Aktif</option>
                                                                <option value="US02">Non-Aktif</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-12 col-lg-6 row justify-content-end">
                                                <div class="col-sm-9">
                                                    <div>
                                                        ...
                                                        <a href="<?php echo site_url("index.php/client/User") ?>" class="btn btn-secondary w-md">Batal</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

                            ...
                            <div class="page-title-box d-sm-flex align-items-center
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="<?php echo site_url('client/Reff') ?>">Referensi</a></li>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row justify-content-between align-items-center">
                                        <h4 class="card-title col-6">Ubah Referensi (<?php echo $reff->name ?>)</h4>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-6">
                                            <div class="mt-4 mt-lg-0">
                                                <form action="<?php echo site_url("index.php/client/Reff/update") ?>" method="POST">
                                                    <div class="row mb-4">
                                                        <label for="id" class="col-sm-3 col-form-label">ID Referensi</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" id="id" value="<?= $reff->id; ?>" name="id" readonly required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" id="name" value="<?= $reff->name; ?>" name="name" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" id="type" value="<?= $reff->type; ?>" name="type" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" id="code" value="<?= $reff->code; ?>" name="code">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row justify-content-end">
                                                        <div class="col-sm-9">
                                                            <div>
                                                                ...
                                                                <a href="<?php echo site_url("index.php/client/Reff") ?>" class="btn btn-secondary w-md">Batal</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>

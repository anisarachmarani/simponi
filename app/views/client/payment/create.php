                            ...
                            <div class="page-title-box d-sm-flex align-items-center
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="<?php echo site_url('client/Payment') ?>">Payment</a></li>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row justify-content-between align-items-center">
                                        <h4 class="card-title col-6">Tambah Payment</h4>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-6">
                                            <div class="mt-4 mt-lg-0">
                                                <form action="<?php echo site_url("index.php/client/Payment/store") ?>" method="POST">
                                                    <div class="row mb-4">
                                                        <label for="name" class="col-sm-3 col-form-label">Nama Payment</label>
                                                        <div class="col-sm-9">
                                                    ...
                                                    <div class="row mb-4">
                                                        <label for="code" class="col-sm-3 col-form-label">Kode Payment</label>
                                                        <div class="col-sm-9">
                                                    ...
                                                    <div class="row justify-content-end">
                                                        <div class="col-sm-9">
                                                            <div>
                                                                ...
                                                                <a href="<?php echo site_url("index.php/client/Payment") ?>" class="btn btn-secondary w-md">Batal</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>

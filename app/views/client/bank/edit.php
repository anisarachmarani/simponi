                            ...
                            <div class="page-title-box d-sm-flex align-items-center
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="<?php echo site_url('client/Bank') ?>">Bank</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-6">
                                            <div class="mt-4 mt-lg-0">
                                                <form action="<?php echo site_url("index.php/client/Bank/update") ?>" method="POST">
                                                    ...
                                                    <div class="row justify-content-end">
                                                        <div class="col-sm-9">
                                                            <div>
                                                                ...
                                                                <a href="<?php echo site_url("index.php/client/Bank") ?>" class="btn btn-secondary w-md">Batal</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>

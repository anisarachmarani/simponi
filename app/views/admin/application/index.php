                                        ...
                                        <tbody>
                                            <?php foreach ($app as $key => $item) : ?>
                                                <tr>
                                                    ...
                                                    <td class="text-wrap">
                                                        <a href="<?php echo site_url('admin/Application/edit/'.$item->id) ?>" class="btn btn-info">Ubah</a>
                                                        <a href="<?php echo site_url('admin/Application/delete/'.$item->id) ?>" class="btn btn-danger">Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>

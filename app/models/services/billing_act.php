...
class Billing_act extends CI_Model {
    ...
    function get($userid, $password, $data, $param, $ip, $env) {
        if ($ip == "")
            return "<response><result>ERROR</result><code>99</code><message>Alamat IP Tidak Valid</message></response>";
        else if ($data == "")
            return "<response><result>ERROR</result><code>99</code><message>Parameter Tidak Valid</message></response>";

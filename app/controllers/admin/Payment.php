...
class Payment extends CI_Controller {
    ...
    {
        $department_id = $this->input->post('department_id'); // $_POST['department']
        ...
        $data["payment"] = $this->payment_model->getAll($department_id, $billing_id, $application_id, $transaction_id, $user_id, $status);
        $data["reff"] = $this->reff_model->getAll();
        $data["status"] = $this->reff_model->status_billing();
        $data["apps"] = $this->app_model->getAll();
        $data["user"] = $this->user_model->getAll();
        ...
        echo $this->load->view("admin/payment/table", $data);
    }
}